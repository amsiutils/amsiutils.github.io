...
namespace Decrypt_String
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string password = Console.ReadLine();
            Console.WriteLine("String to decrypt:");
...
[encrypt]: https://github.com/amsiutils/encryptstring
[decrypt]: https://github.com/amsiutils/decryptstring
